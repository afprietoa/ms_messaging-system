...
public class ShipmentController {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public Shipment updateShipment(@ApiParam(value = "shipment id", required = true) @PathVariable("id") String id, @ApiParam(value = "shipment object", required = true) @RequestBody Shipment shipment){
